@php
    $links = [
        ...
        [
            ...
            'label' => 'Students',
            'icon' => 'M12 14l9-5-9-5-9 5 9 5zm0 0v6m-9-3v3l9 4 9-4v-3',
        ],
        [
            'route' => 'admin.teachers.index',
            'label' => 'Teachers',
            'icon' =>
                'M17 20h5v-2a4 4 0 00-3-3.87M9 20H4v-2a4 4 0 013-3.87m5-2a4 4 0 100-8 4 4 0 000 8zm6 3a4 4 0 10-8 0',
        ],
        [
        ...
        [
            ...
            'label' => 'Reports',
            'icon' => 'M9 17v-2a4 4 0 018 0v2M3 12a9 9 0 1018 0 9 9 0 00-18 0z',
        ],
        [
