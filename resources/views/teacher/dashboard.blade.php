    ...
    <div class="bg-white rounded-card shadow-soft p-6">
        ...
        <div class="space-y-3">
            @forelse($announcements as $a)
                <a href="{{ route('teacher.announcements.show', $a) }}" class="block hover:bg-slate-50 rounded-lg p-2 -mx-2 transition-colors overflow-hidden">
...
<div class="bg-white rounded-card shadow-soft p-6">
    ...
    <div class="space-y-4">
        @forelse($announcements as $a)
            <a href="{{ route('teacher.announcements.show', $a) }}" class="block border-l-4 border-brand pl-4 py-1 hover:bg-slate-50 rounded-r-lg transition-colors overflow-hidden">
