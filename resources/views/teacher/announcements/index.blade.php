...
<div class="space-y-4">
    @forelse($announcements as $a)
        <a href="{{ route('teacher.announcements.show', $a) }}" class="block bg-white rounded-card shadow-soft p-5 hover:shadow-md transition-shadow border-l-4 border-brand overflow-hidden">
